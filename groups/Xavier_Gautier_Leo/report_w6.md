...
## Travail commun
> Celui-ci est maintenant décrit dans [report-chess.md](https://github.com/LeoDefossez/Miage-C3P/blob/2025/groups/Xavier_Gautier_Leo/report-chess.md)

### Léo Defossez
> Durant cette semaine, j'ai surtout réalisé le kata nil checks (disponible sur le lien dans [Travail commun](#Travail-commun)).  
