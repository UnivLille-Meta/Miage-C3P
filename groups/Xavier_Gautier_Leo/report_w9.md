...
> Build strategy : 
> 
>     J'ai proposé l'ajout d'une stratégie couplée donc à de la     délégation. J'ai     proposé et réaliser ce choix, car pour moi, on doit avoir la     possibilité de     changer facilement de manière de construire notre board que     ce soit avec     les SGbox présentes ou même de leur répartition. Hardcoder     chaque     manière sans pouvoir en retirer facilement serait difficilement maintenable.     L'utilisation de stratégies m'a donc paru le plus approprié.
> 
> ScoreStrategyCalculator : 
> 
>     Même chose que pour la build strategy, celle du score peut nous permettre     de faire varier le niveau de difficulté ou alors de créer des bonus, ou alors de     baissé la force de certains state. On pourra donc moduler facilement et de     manière à centraliser la gestion du calcul du score.
