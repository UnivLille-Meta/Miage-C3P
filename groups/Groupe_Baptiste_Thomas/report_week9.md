...
Cette semaine, nous avons commencé à travailler sur le projet Miner. Après avoir lu la documentation du jeu et réfléchi aux différents challenges à réaliser. On a débuté par la mise en place du compteur du nombre de sélections, afin de mieux comprendre le fonctionnement du jeu et préparer les prochaines étapes. Nous avons mis en place le sysème de compteur lors d'un click sur une case safe cependant nous avons du mal à afficher ca visuellement dans notre jeux.
